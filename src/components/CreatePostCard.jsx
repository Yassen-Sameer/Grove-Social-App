...
export default function CreatePostPage() {
  ...
  return (
    <div className="w-full md:max-w-[90%] lg:max-w-2xl mx-auto flex justify-center px-4 sm:px-6 py-6 space-y-5">
      <form
        onSubmit={createPost}
      ...
      >
        ...
        <div className="pt-4 border-t border-white/10 flex items-center justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={submitLoading || !(file || caption)}
